...
{
    public static readonly ExpressionBodyForConstructorsHelper Instance = new();
...
{
    public static readonly ExpressionBodyForConversionOperatorsHelper Instance = new();
...
{
    public static readonly ExpressionBodyForMethodsHelper Instance = new();
...
{
    public static readonly ExpressionBodyForOperatorsHelper Instance = new();
...
{
    public static readonly ExpressionBodyForAccessorsHelper Instance = new();
...
{
    public static readonly ExpressionBodyForIndexersHelper Instance = new();
...
{
    public static readonly ExpressionBodyForPropertiesHelper Instance = new();
